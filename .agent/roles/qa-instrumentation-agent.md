...
Despite the use of Agent in Agent World Index (AWI), it refers to the citizen's agentic nature, not the citizen itself. We will always refer to the inhabitants of the in-game world as citizens.

## What You Own

- `/tests/`
- `/crates/dark_city_instrumentation/`
